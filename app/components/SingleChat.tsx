  ...
  return (
    <main className="w-[75%]">
      <div className="w-full flex p-2 bg-[#303033] h-16">
        <Image src={user.profileImage} width={45} height={45} className="rounded-full ml-2" alt='' />
        <div className=" ml-2">
      ...
      <div className="flex h-[72vh] messageBar overflow-auto bg-yellow-100 flex-col">
        {new Array(16).fill("").map((item, index) => (
          <div
            key={index}
            className={`flex w-[75%] p-3 max-w-xs ${index % 2 === 0 ? 'justify-start' : 'justify-end ml-auto'}`}
          >
            {index % 2 === 0 ? (
              <>
